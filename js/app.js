...
// Test for Titel Media

// The conditionals in window and document are there to allow
// testing in Mocha without PhantomJS or further work with jsdom
...
var formatDate = (a) => {
        ...
        if (dateIsRight(date1)) {
            ...
            // Date in case that it doesn't work. It could also return null or some error
